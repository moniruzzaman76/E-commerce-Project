...
class ProductController extends GetxController {
  ...
  Future<bool>getPopularProducts()async{
    ...
    update();
    final response = await NetworkUtils().getMethod(Urls.productByRemarksUrl('popular'));
  ...
  Future<bool>getSpecialProducts()async{
    ...
    update();
    final response = await NetworkUtils().getMethod(Urls.productByRemarksUrl('special'));
